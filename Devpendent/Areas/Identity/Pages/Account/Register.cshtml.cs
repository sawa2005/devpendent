...
namespace Devpendent.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserEmailStore<DevpendentUser> _emailStore;
        ...
        private DevpendentUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<DevpendentUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(DevpendentUser)}'. " +
                    $"Ensure that '{nameof(DevpendentUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<DevpendentUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<DevpendentUser>)_userStore;
        }
    }
}
